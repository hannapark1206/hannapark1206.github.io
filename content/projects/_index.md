    ...
    content:
      ...
      text: |
        ...
        <a class="project-card" href="/projects/firefighting-hardware-prototype/">
          <div class="project-image">
            <img src="/projects/firefighting-hardware-prototype/firefighting.png" alt="Firefighting hardware prototype image" onerror="this.parentElement.classList.add('placeholder'); this.remove();">
          </div>
          <div class="project-body">
