...
summary: "Rapid prototyping, mechanical assembly, hardware modification, and field demonstration support for a firefighting-related robotic system."
date: 2026-05-01
toc: false
share: false
commentable: false
...
<div class="project-cover-wrap">
  <img class="project-cover" src="firefighting.png" alt="Tracked firefighting hardware prototype during an outdoor field demonstration">
</div>
...
.field-shot::after {
  ...
  background: linear-gradient(
    to top,
    rgba(10, 14, 24, 0.66) 0%,
    rgba(10, 14, 24, 0.25) 26%,
    rgba(10, 14, 24, 0.04) 53%,
    transparent 72%
  );
  opacity: 0.82;
...
/*
  Your 3.png image is sideways in the uploaded version.
  This displays it upright without needing to re-export it.
*/
.rotated-image-wrap {
  position: absolute;
  inset: 0;
...
.shot-overview .rotated-image-wrap img {
  position: absolute;
  width: 100%;
  height: 205%;
  left: 0;
...
.shot-overview:hover .rotated-image-wrap img {
